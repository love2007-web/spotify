        ...
        <>
            <div>
                ...
                <div className='next w-3/12 mx-2 rounded-xl pl-4 pr-4'>
                    ...
                    <div className='pl-2 flex justify-between text-white mt-4 items-center cursor-pointer'>
                    ...
                    <div>
                        <ul class="max-h-[300px] overflow-y-scroll text-white py-4">
                            <li className='flex cursor-pointer hover:bg-white'>
                                <div className='ts'>
                                    <img className='rounded-md' src={require('./images/liked-songs-640.png')} alt="" />
                                </div>
                                <div className='mx-3'>
                                    <h5>Liked Songs</h5>
                                    <div className='flex'>
                            ...
                            <li className='flex items-center'>
                                <div className='ts py-2'>
                                    <img className='rounded-full' src={require('./images/ardee.png')} alt="" />
                                </div>
                                <div className='mx-3'>
                                    <h4>Ardee</h4>
                                    <p>Artist</p>
